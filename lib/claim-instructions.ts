...
function threeOptionNote(cancelOption: string) {
  return [
...
const EXISTING_SUBSCRIPTION_NOTE = threeOptionNote(
  "Cancel your current subscription, once the expiration date arrives sign up again with this code."
);

const CANCEL_ACCOUNT_SUBSCRIPTION_NOTE = threeOptionNote(
  "Cancel your account, once the expiration date arrives sign up again with this code"
);
